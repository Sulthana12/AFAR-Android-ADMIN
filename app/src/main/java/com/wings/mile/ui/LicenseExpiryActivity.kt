...
class LicenseExpiryActivity : BaseActivity(),LicenseExpiryAdapter.OnItemClicked  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.expiry.actionbarAccount.toolbarTitle.text = "License Expiry Details"
        ...
        searchview()
        viewModel!!.getdriverlicenseexpirydetails(0).observe(this, Observer {
            if (it != null) {
    ...
    private fun showdialog() {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(android.R.string.yes) { dialog: DialogInterface?, which: Int ->
                val intent= Intent(this, LicenseExpiryActivity::class.java)
