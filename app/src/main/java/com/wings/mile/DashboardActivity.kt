...
class DashboardActivity : BaseActivity(), OptionDialogFragment.OnItemSelect,
   ...
   // val REQUEST_PHONE_CALL = "android.permission.CALL_PHONE"
    ...
    private lateinit var commodityFragment: Driverdetails1
    private lateinit var Driver: Driverdetails2
...
//                bundle.putString("SaveRequest", Gson().toJson(savedriver))
                ...
                Pref_storage.setDetail(this,"Driverdetails",Gson().toJson(savedriver))
...
//    }
    ...
    override fun onBackPressed() {
     ...
     fun attachFragment() {
        commodityFragment = Driverdetails1()
        val bundle = Bundle()
