...
import com.wings.mile.ui.InsuranceExpiryActivity;
import com.wings.mile.ui.LicenseExpiryActivity;
import com.wings.mile.ui.UserAccountsActivity;
...
public class NavigationListAdapter extends RecyclerView.Adapter<NavigationListAdapter.NavigationViewHolder> {
    ...
    public void onBindViewHolder(NavigationViewHolder holder, int position) {
        ...
        holder.licenseexpiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                holder.licenseexpiry.setTextColor(context.getColor(R.color.proceed_btncolor));
                holder.insuranceexpiry.setTextColor(context.getColor(R.color.menu_text));
                Intent next=new Intent(context, LicenseExpiryActivity.class);
                context.startActivity(next);
            }
        });
        holder.insuranceexpiry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.icon.setColorFilter(context.getColor(R.color.proceed_btncolor));
                holder.name.setTextColor(context.getColor(R.color.proceed_btncolor));
                holder.insuranceexpiry.setTextColor(context.getColor(R.color.proceed_btncolor));
                holder.licenseexpiry.setTextColor(context.getColor(R.color.menu_text));
                Intent next=new Intent(context, InsuranceExpiryActivity.class);
                context.startActivity(next);
            }
        });

        holder.useraccounts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.icon.setColorFilter(context.getColor(R.color.proceed_btncolor));
                holder.name.setTextColor(context.getColor(R.color.proceed_btncolor));
                holder.licenseexpiry.setTextColor(context.getColor(R.color.menu_text));
                holder.insuranceexpiry.setTextColor(context.getColor(R.color.menu_text));
                holder.useraccounts.setTextColor(context.getColor(R.color.proceed_btncolor));
                Intent next=new Intent(context, UserAccountsActivity.class);
                context.startActivity(next);
            }
        });
        if(model.getChecked()) {
