...
class OptionDialogFragment(var onItemClicked: OnItemSelect, var visibility: Boolean, var value : Int) : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(title: String, subTitle: String, activity: MainActivity): OptionDialogFragment {
            val args = Bundle()
            args.putString(KEY_TITLE, title)
            args.putString(KEY_SUBTITLE, subTitle)
            val fragment = OptionDialogFragment(onItemClicked = activity, visibility = false,value = 2)
