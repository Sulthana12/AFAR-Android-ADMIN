...
class CustomSuccessDialogFragment(var onItemClicked: OnItemSelectDialog, var titleText: Int = R.string.application_has_been_updated_successfully, var imgDialog: Int? = null) : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(title: String, subTitle: String, activity: MainActivity, titleText: Int): CustomSuccessDialogFragment {
            val args = Bundle()
